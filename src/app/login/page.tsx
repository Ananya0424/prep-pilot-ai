    ...
    <div className="relative min-h-[80vh] flex items-center justify-center">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight mb-2">Welcome to PrepPilot AI</h2>
          <p className="text-sm text-slate-500">Sign in to build and access your tailored interview prep kits.</p>
        </div>
