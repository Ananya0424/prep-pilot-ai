            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-10 max-w-3xl">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">Understand the company, its culture and hiring process</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">Identify key skills, responsibilities and expectations</p>
                </div>
              </div>

              <div className="flex gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-purple-50 flex items-center justify-center text-purple-600">
                  <MessageSquare className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-[15px] font-bold text-slate-900 mb-1">Smart Questions</h3>
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">Role-specific and behavioral interview questions</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">Personalized preparation plan based on your timeline</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 xl:col-span-4 xl:col-start-9 w-full flex justify-center lg:justify-end">
            <div className="w-full max-w-[420px] bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-[24px] p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]">
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  <label className="block text-[11px] font-bold text-slate-600 mb-2">Email Address</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 text-sm transition-all font-medium shadow-sm hover:border-slate-300"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Link href="#" className="text-[11px] font-bold text-brand-600 hover:text-brand-700 hover:underline">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 mt-2 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl shadow-[0_8px_20px_-8px_rgba(79,70,229,0.6)] hover:shadow-[0_12px_25px_-8px_rgba(79,70,229,0.7)] hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 text-sm relative group flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col items-center gap-3">
                ...
                <Link 
                  href="/register" 
                  className="w-full py-3 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-bold rounded-xl shadow-sm transition-all text-sm text-center flex items-center justify-center gap-2"
                >
